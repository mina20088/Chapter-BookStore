        ...
        <div class="row">
            <div class="col-md-6 d-flex flex-column justify-content-md-center align-items-lg-end">
                <div class="hero-section-writings d-flex flex-column justify-content-md-center">
                    ...
                    <p class="text-secondary mb-sm-5">The world was a place of sound. It was a world of clatter and hum and hiss. It was a world of voices and music and traffic noise. But then, one day, the sound stopped. Abruptly, without warning, the world fell silent. There was no wind, no rain, no birdsong. There was just...nothing</p>
            ...
            <div class="col-md-6">
                <div class="new-release-book-cover-wrapper d-flex justify-content-md-center">
                    <img class="new-release-book-cover img-fluid" src="{{ \Illuminate\Support\Facades\Vite::asset("/resources/images/Black and Grey Dark Forest Aesthetic Book Cover.png") }}" alt="new Relase">
                </div>
            </div>
        </div>
    </div>
