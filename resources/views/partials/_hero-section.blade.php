        ...
        <div class="row">
            <div class="col-md-6 d-flex flex-column justify-content-md-center align-items-lg-end">
                <div class="hero-section-writings d-flex flex-column justify-content-md-center">
                    ...
                    <h1 class="display-1 text-secondary">{{ $book->title  }}</h1>
                    <p class="text-secondary mb-sm-5">{{ $book->description }}</p>
                    <div class="hero-section-price d-flex justify-content-sm-center gap-4">
                        <button class="btn btn-outline-danger btn-lg fs-2 py-lg-2">
                            <a class="text-decoration-none" href="">
                                <span style="font-size:1.1em;">{{ $price }}</span>
                                <i class="fa-solid fa-e fa-sm"></i><i class="fa-solid fa-sterling-sign fa-sm"></i>
                            </a></button>
            ...
            <div class="col-md-6">
                <div class="new-release-book-cover-wrapper d-flex justify-content-md-center">
                    ...
                    <img class="new-release-book-cover img-fluid" src="{{ $book->cover_image }}" alt="new Relase">
                </div>
            </div>
        </div>
    </div>
